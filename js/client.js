...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const createClientHeader = (parent) => {
    ...
    headerTitle.innerText = 'Client card';
  ...
  const getDate = (date, label, container) => {
  ...
  const getClientDate = async (parent) => {
    ...
    labelCreate.innerText = 'Date and time of creation: ';
    labelChange.innerText = 'Recent changes: ';
